 ...
 */
public class MyRunCreateNetworkFromOSM {

	private static String UTM32nAsEpsg = "EPSG:32632";
	private static Path input = Paths.get("C:\\Users\\lenovo\\Documents\\thueringen-251128.osm.pbf");
	private static Path filterShape = Paths.get("C:\\Users\\lenovo\\Documents\\dingelstaedt_qgis.shp");

	public static void main(String[] args) throws MalformedURLException {
		new MyRunCreateNetworkFromOSM().create();
	}
	...
	private void create() throws MalformedURLException {
		...
		new NetworkWriter(network).write("C:\\Users\\lenovo\\Documents\\network.xml.gz");
	}
}
